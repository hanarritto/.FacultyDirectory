...
4. Login testing:
   Use a structurally valid prototype Student ID created for testing.
   Do not publish real student credentials in the repository.
Main structure
--------------
...
Example:
67 2 431 NNN = admission year | group | program code | running number
